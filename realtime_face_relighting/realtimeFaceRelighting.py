...
class faceRelighting:
    ...
    def display(self):
        ...
        #rotate light
        #glPushMatrix()
        #glRotatef(self.rot, 0.0, 0.0, 0.0);
        #glLight(GL_LIGHT0, GL_POSITION, (1, 0, 0, 0)) #light from right
        #glPopMatrix()
    ...
    def idle(self):
        ...
        if _ret==True:
            ...
            alpha = 0.05
            #mesh = o3d.geometry.TriangleMesh.create_from_point_cloud_alpha_shape(pcd, alpha) #alpha shapes
            #mesh.compute_vertex_normals()
            radii = [0.005, 0.01, 0.02, 0.04]
            mesh = o3d.geometry.TriangleMesh.create_from_point_cloud_ball_pivoting(pcd, o3d.utility.DoubleVector(radii)) #ball pivoting
            mesh.compute_vertex_normals()
            #mesh, densities = o3d.geometry.TriangleMesh.create_from_point_cloud_poisson(pcd) #poisson surface
            #mesh.compute_vertex_normals()
